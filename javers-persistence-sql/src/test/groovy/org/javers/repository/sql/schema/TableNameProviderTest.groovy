...
class TableNameProviderTest extends Specification {
    ...
    def "should provide default names without schema" () {
        ...
        def names = new TableNameProvider(
                new SqlRepositoryConfiguration(false, false, null, true, null, null, null, null, null, null, null))
    ...
    def "should provide default names with schema" () {
        when:
        def names = new TableNameProvider(
                new SqlRepositoryConfiguration(false, false, 's', true, null, null, null, null, null, null, null))
    ...
    def "should provide custom table names" () {
        when:
        def names = new TableNameProvider(
                new SqlRepositoryConfiguration(false, false, null, true, "g", "c", "s", "cp", null, null,  null))
